...
from dropstyle_obs import dropstyleObsBuilder, BOOST_LOCATIONS
...
class dropstyle(BaseAgent):
    def __init__(self, name, team, index,
        ...
        print('dropstyle Ready - Index:', index)
        print("Remember to run dropstyle at 120fps with vsync off! "
    ...
    def initialize_agent(self):
        ...
        self.obs_builder = dropstyleObsBuilder(field_info=self.field_info)
